...
constraints = [
    ...
    { 'type' : 'ineq',   'fun' : lwe(lambda x : domain(x) - R1_hyb(x))},
    
    # Require enough Layer-2 representations
    { 'type' : 'ineq',   'fun' : lwe(lambda x : domain(x) - 2*R2_hyb(x))},

    # Domain restriction
    { 'type' : 'ineq',   'fun' : lwe(lambda x :  multiH(1,[w/2,w/2]) - ss(x))},

    # Feasibility condition
    { 'type' : 'ineq',   'fun' : lwe(lambda x : (1-x.g1-x.g2)/4 - (1-x.g1*x.b1-x.g2*x.b2)*w/4)},


    # ==============================================================================================
    #                                   Constraints for the Shifted part
    # ==============================================================================================

    # ===========================================================
    # Constraints in Level 0
    # ===========================================================
    { 'type' : 'ineq',   'fun' : lwe(lambda x : 1-x.g1-x.g2)},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : 1-x.g1*x.b1-x.g2*x.b2)},
    ...
    # ==============================================================================================
    #                                   Constraints for the Improved Nested-2star part
    # ==============================================================================================
    ...
    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn1_0(x)/2- x.bo1_0)},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : -x.bz1_0 - x.bz2_0 + bn0_0(x)/2)},


    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn0_1(x))},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn1_1(x))},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn2_1(x))},

    { 'type' : 'ineq',   'fun' : lwe(lambda x : bR_1(x))},
    ...
    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn2_1(x)/2- x.bt_1)},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn1_1(x)/2- x.bo1_1)},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : -x.bz1_1 - x.bz2_1 + bn0_1(x)/2)},


    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn0_2(x))},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn1_2(x))},
    { 'type' : 'ineq',   'fun' : lwe(lambda x : bn2_2(x))},

    { 'type' : 'ineq',   'fun' : lwe(lambda x : bR_2(x))},
...
def single_optimization_run(run_id):
    ...
    start = [ru(0, 0.009) for _ in range(27)] + [ru(0.1, 0.5) for _ in range(4)] + [ru(0.1,0.11)]

    bounds=[(0.,0.1)]*27+[(0,1)]*4+[(0,0.5)]
